...
import { Dumbbell, Plus, Calendar, Clock, Flame, Trash2, Edit, Save, X, Sparkles, List, Bot, Target } from 'lucide-react';
...
export default function WorkoutsPage() {
    ...
    const [viewMode, setViewMode] = useState<ViewMode>('ai-tracker');
                ...
                <div className="space-y-6">
                    {!isWorkoutActive ? (
                        <>
                            ...
                            {/* Configuration Modal - Moved above Exercise Selector */}
